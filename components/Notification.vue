...
<template>
    <div class="mt-2">
        ...
        <div id="dropdownNotification"
            ...
            <div
                class="block px-4 py-2 font-medium text-center text-gray-700 rounded-t-lg bg-green-300 dark:bg-gray-800 dark:text-white">
                Notifications
            </div>
                ...
                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <div class="w-full pl-3">
                        <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">New message from <span
                                class="font-semibold text-gray-900 dark:text-white">Jese Leos</span>: "Hey, what's up?
                            All set for the presentation?"</div>
                ...
                <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <div class="w-full pl-3">
                        <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span
                            ...
                            you in a comment: <span class="font-medium text-blue-500" href="#">@bonnie.green</span>
                            what do you say?</div>
            ...
            <a href="#"
                class="block py-2 text-sm font-medium text-center text-gray-900 rounded-b-lg bg-green-300 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
