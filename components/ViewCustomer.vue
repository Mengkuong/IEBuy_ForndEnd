...
<template>
    ...
    <div class="relative overflow-x-auto sm:rounded-lg mt-[100px] ml-5 font-serif">
        ...
        <h1 class="font-bold mt-2 text-3xl ml-2 h-[150%]">Staff Management</h1>
    </div>
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="7e3b6d714addc91bafb74a509608603e.jpg" alt="Jese image">
                        <div class="pl-3">
                    ...
                    <td class="ml-[100px] px-6 py-4 inline-flex justify items-center space-x-1 ">
                        <a href="staff_profile" class="flex text-white bg-yellow-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row"
                        ...
                        <img class="w-10 h-10 rounded-full" src="744ef31bef27d1ed525a70a615a53995.jpg" alt="Jese image">
                        <div class="pl-3">
                    ...
                    <td class="ml-[100px] px-6 py-4 inline-flex justify items-center space-x-1 ">
                        <a href="" class="flex text-white bg-yellow-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5">
                                <path d="M10 12.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
                                <path fill-rule="evenodd"
                                    d="M.664 10.59a1.651 1.651 0 010-1.186A10.004 10.004 0 0110 3c4.257 0 7.893 2.66 9.336 6.41.147.381.146.804 0 1.186A10.004 10.004 0 0110 17c-4.257 0-7.893-2.66-9.336-6.41zM14 10a4 4 0 11-8 0 4 4 0 018 0z"
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="8055f8dd50e6965cd3a00918a0845a3b.jpg" alt="Jese image">
                        <div class="pl-3">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="cf7ff1065b9514dacee1e26a2f5554a0.jpg" alt="Jese image">
                        <div class="pl-3">
                ...
                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="b41856847f70be1372d6c56c3480da8a.jpg" alt="Jese image">
                        <div class="pl-3">
