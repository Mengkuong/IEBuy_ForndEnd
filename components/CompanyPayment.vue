...
<template>
    <div class="p-4 sm:ml-64">
        <div class="relative overflow-x-auto sm:rounded-lg mt-[100px] ml-5 font-serif">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Payment</a>
                        </div>
                    </li>
            ...
            <h1 class="font-bold mt-2 text-3xl h-[150%]">Company Management</h1>
            <p class="text-sm text-gray-600 ml-2 mt-2">This list was completed by finance at IEBuy Company</p>
        </div>
