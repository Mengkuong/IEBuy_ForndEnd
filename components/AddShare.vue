                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Share</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="max-w-md mx-auto">
                    <div class="flex items-center space-x-5">
                        ...
                        <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                            <h2 class="leading-relaxed h-[50%]">Add Shares</h2>
                            <p class="text-sm text-gray-500 font-normal leading-relaxed">Complete information to add share into your account
                            </p>
                        </div>
                    </div>
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:leading-7">
                            ...
                            <div class="flex flex-col">
                                <label class="leading-loose">Share:</label>
                                <input type="date"
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type=""
                                    class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                    placeholder="price of share">
                            </div>
                        </div>
                        <div class="pt-4 flex items-center space-x-4">
                            <button
                                class="flex justify-center items-center  w-full text-gray-900 px-4 py-2 rounded-md focus:outline-none bg-red-100 hover:bg-red-500 focus:ring-4 focus:ring-red-300  mr-2 mb-2 dark:focus:ring-red-900">
