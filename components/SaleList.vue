                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Sale List</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="font-bold mt-2 text-3xl  h-[150%]">User Sale List</h1>
             <p class="text-sm text-gray-500 mt-2">Sale Share of user will be shown in here</p>
        </div>
        <div class="flex py-4 bg-white dark:bg-gray-800 ml-8">
            <div class="relative">
                            ...
                            <div class="inline-block w-[100%] py-2 md:px-6 lg:px-8 font-serif text-s">
                                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead
                                            class="bg-yellow-300 dark:bg-gray-800">
                                            <tr>
                                                <th scope="col"
