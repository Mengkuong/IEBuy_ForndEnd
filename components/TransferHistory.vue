...
<template>
    <div class=" p-4 sm:ml-64 font-serif">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">History</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Transfer</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="font-bold mt-2 text-3xl  ">Transfer History</h1>
            <p class="text-sm text-gray-500 my-2">Your transfer will record in here</p>

        </div>
        <div class="flex ml-[860px] py-4 bg-white dark:bg-gray-800 ">
        ...
        <div class="relative overflow-x-auto  w-[100%]  h-max font-serif">
            <div class="bg-white p-3 rounded-lg">
                <section class="container px-5 mx-auto">

                    <div class="flex flex-col">
                        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block w-[100%] py-2 md:px-6 lg:px-8 font-serif ">
                    ...
                    <div class="flex items-center justify-between mt-6 w-1/2 ml-[300px]">
                        <a href="#"
