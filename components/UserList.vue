...
<template>
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg mt-[100px] ml-5 font-serif">
            ...
            <h1 class="font-bold mt-2 text-3xl ml-2 h-[150%]">User Management</h1>
        </div>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-[95%] mt-2 ml-5 h-max font-serif">
            ...
            <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800 mx-2 ">
                <NuxtLink to="create_user">
                    <button type="button"
                        class="inline-flex focus:outline-none ml-1 font-medium rounded-lg text-sm px-5 py-2.5 bg-cyan-500 hover:bg-blue-500 focus:ring-4 focus:ring-blue-300  mr-2 mb-2 dark:focus:ring-blue-900">
                ...
                <tbody>
                    <tr
                        ...
                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            ...
                            <div class="text-medium font-semibold">Neil Sims</div>
                        ...
                        <td class="px-6 py-4 inline-flex justify items-center space-x-1 ">
                            <a href="user_info" data-modal-target="editUserModal" data-modal-show="editUserModal"
                                class="flex text-white bg-yellow-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center"><svg
                            ...
                            <a href="user_update" data-modal-target="editUserModal" data-modal-show="editUserModal"
                                class="flex text-white bg-blue-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center"><svg
                    ...
                    <tr
                        ...
                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            ...
                            <div class="text-medium font-semibold">Hai Mengkoung</div>
