...
<template>
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg mt-[100px] ml-5 font-serif">
            ...
            <p class="ml-2 text-sm mt-2 text-gray-500">The information of customer will be stored in this list</p>
        </div>
        <div class="flex items-center  py-4  dark:bg-gray-800 font-serif">
                ...
                <div class="flex py-4 bg-white dark:bg-gray-800 ml-[650px]">
                    <div class="relative">
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 inline-flex justify items-center space-x-1 ">
                            <a href="user_info" data-modal-target="editUserModal" data-modal-show="editUserModal"
                                class="flex text-white bg-yellow-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center"><svg
