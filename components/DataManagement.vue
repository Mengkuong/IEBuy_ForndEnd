...
<template>
    <div class="p-4 sm:ml-64 font-serif">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg mt-[100px] ml-5 font-serif">
            ...
            <h1 class="font-bold mt-2 text-3xl  h-[150%]">Data Management</h1>
            <p class="text-gray-500 text-sm mt-1 ">Company data after complete will show here</p>
        </div>
        <div class="flex items-center py-4 dark:bg-gray-800 ">
                <NuxtLink to="upload_data">
                    <button type="button"
                        ...
                        <span class="">Create New Data</span>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-[95%]  ml-5 h-max font-serif">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-green-300 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 float-right mr-56">
                            Action
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr
                        ...
                        <td class="px-4 py-4  text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                            <div class="inline-flex items-center gap-x-3 font-sans">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center bg-green-200 rounded-lg w-fit ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="w-5 h-5">
                                    <path fill-rule="evenodd"
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center bg-red-300 rounded-lg w-fit ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="w-5 h-5">
                                    <path fill-rule="evenodd"
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center bg-yellow-200 w-fit rounded-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="w-5 h-5">
                                    <path fill-rule="evenodd"
