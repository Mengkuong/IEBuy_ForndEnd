        ...
        <div class="w-[80%]  h-screen">
          <div class="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
            <div class="g-0 lg:flex lg:flex-wrap">
              <div class="flex rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none bg-yellow-100">
                <img src="undraw_real_time_analytics_re_yliv.svg" class="hidden lg:block w-[60%] hover:scale-150 transition-all duration-500 transform mx-auto"/>
              </div>
              <div class="px-4 md:px-0 lg:w-6/12 mt-3">
                <div class="md:mx-6 md:p-12">
                  <div class="text-center">
                    <img class="mx-auto w-32" src="icon (1).png" alt="logo" />
