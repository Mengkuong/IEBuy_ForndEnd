...
<template>
    <div class=" p-4 sm:ml-64 font-serif">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Buy
                                Shares</a>
                        </div>
                    </li>
        ...
        <div class="relative overflow-x-auto  w-[75%] mt-2  h-max font-serif">
            <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800 mx-2 ">
                ...
                <div class="relative ml-3">
                    ...
                    <input type="text" id="table-search-users"
                        class="mr-[100px] p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
