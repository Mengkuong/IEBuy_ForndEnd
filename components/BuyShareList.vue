    ...
    <div class=" p-4 sm:ml-64 font-serif">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Buy List</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="font-bold mt-2 text-3xl  h-[150%]">Buy Share Stock</h1>
        </div>
        <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800 ">
            <div class="relative ml-3">
                ...
                <button type="submit"
                    class="absolute top-0 right-0 p-2 pl-3 text-sm font-medium text-white bg-yellow-500 rounded-r-lg border border-yellow-500 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                    ...
                    <div class="inline-block min-w-[100%] py-2 align-middle md:px-6 lg:px-8  font-serif">
                        <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gradient-to-r from-orange-300 to-rose-300 dark:bg-gray-800">
                                    <tr>
                                        <th scope="col"
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    <tr>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm flex space-x-1">
                                            <a href="#" data-modal-target="editUserModal" data-modal-show="editUserModal"
                                                class="flex text-white bg-red-500 hover:bg-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center">
                                            ...
                                            <a href="#" data-modal-target="editUserModal" data-modal-show="editUserModal"
                                                class="flex text-white bg-yellow-500 hover:bg-gradient-to-br hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 font-medium rounded-lg text-sm px-2 py-1.5 text-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                    fill="currentColor" class="w-5 h-5">
                                                    <path fill-rule="evenodd"
