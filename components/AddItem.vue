...
<template>
  <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 font-serif">
    <nav class="flex mb-4 ml-[200px]" aria-label="Breadcrumb">
        ...
        <div class="max-w-md mx-auto">
          <div class="flex items-center space-x-5">
            ...
            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
              <h2 class="leading-relaxed h-[50%]">Create an Items</h2>
              <p class="text-sm text-gray-500 font-normal leading-relaxed">Finance have to complete this form before add
                an item</p>
            </div>
          </div>
          <div class="divide-y divide-gray-200">
            ...
            <div class="pt-4 flex items-center space-x-4">
              <button
                class="flex justify-center items-center w-full text-gray-900 px-4 py-2 rounded-md focus:outline-none">
