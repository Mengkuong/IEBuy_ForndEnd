...
<template>
    <div class="relative overflow-x-auto  sm:rounded-lg mt-[100px] ml-[200px] font-serif">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Finance</a>
                    </div>
                </li>
        ...
        <h1 class="font-bold mt-2 text-3xl ml-2 h-[150%]">Finance Management</h1>
    </div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-[75%] mt-2 ml-[200px] h-max font-serif">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="ml-[50px] inline-flex justify items-center space-x-1 mb-5">
                        <!-- Modal toggle -->
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="ml-[30px] px-6 py-4 inline-flex justify items-center space-x-1 mb-3">
