                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Add Share History</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="font-bold mt-2 text-3xl  "> Add Share History</h1>
            <p class="text-sm text-gray-500 my-2">Your share holder will record in here</p>
