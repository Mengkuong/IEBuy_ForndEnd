      ...
      <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
         <div class="flex flex-wrap my-5 -mx-2">
            <div class="w-full lg:w-1/3 p-2">
               <div class="flex items-center flex-row w-full bg-gradient-to-r from-sky-400 to-blue-500 rounded-md p-3">
                  <div
...
<<<<<<< HEAD
         ...
         <div class="grid grid-cols-2">
            ...
            <div class=" bg-gray-50 ml-[170px]  px-4 py-3 shadow-lg rounded mb-2 h-[95%]">
               ...
               <ul class="max-w-md divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <li class="py-3 sm:py-4">
                     <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                           <img class="w-8 h-8 rounded-full"
                              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAL1JT6g2AXAX4hPYHVOanA4HLwnOIwyplIg&usqp=CAU"
                              alt="Neil image">
                        </div>
                        <div class="flex-1 min-w-0">
                           <p class="text-sm font-medium text-gray-900 truncate dark:text-white">
                  ...
                  <li class="py-3 sm:py-4">
                     <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                           <img class="w-8 h-8 rounded-full"
                              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS47ASN-MW8K-nV9Ck_UZmUFmPF-vRavR5zOA&usqp=CAU"
                              alt="Neil image">
                        </div>
                        <div class="flex-1 min-w-0">
                           <p class="text-sm font-medium text-gray-900 truncate dark:text-white">
                     ...
                     <div class="rounded-t px-1 py-3 bg-transparent flex">
                        <div class="max-w-md divide-y mt-2 divide-gray-200 dark:divide-gray-700">
                           <button id="dropdownLeftButton" data-dropdown-toggle="dropdownLeft"
                              ...
                              class="flex mb-3 md:mb-0 text-gray-500 text-sm rounded hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs"
                              type="button">Last 7 days<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
