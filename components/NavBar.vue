         ...
         <ul class="space-y-2">
            ...
            <li>
               ...
               <ul id="dropdown-ecommerce" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="sale_form"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Sell
                        Form
                     </a>
                  </li>
                  <li>
                     <a href="share_management"
                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Amount
                        Share</a>
                  </li>
               </ul>
            </li>
