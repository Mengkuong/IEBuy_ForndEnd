...
<template>
   <nav
      class="bg-yellow-500 fixed top-0 z-40 w-full border-b border-yellow-400 dark:bg-gray-800 dark:border-gray-700  font-serif">
   ...
   <aside id="logo-sidebar"
      class="fixed top-0 left-0 z-0 w-64 h-screen pt-20 transition-transform -translate-x-full bg-yellow-500 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
      aria-label="Sidebar">
